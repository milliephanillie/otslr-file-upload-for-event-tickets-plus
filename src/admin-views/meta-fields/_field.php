...
>
	...
	<div class="inside">
		...
		<?php include OTSLR_ADD_PLUGIN_PATH . 'src/admin-views/meta-fields/_placeholder.php'; ?>
        <?php include OTSLR_ADD_PLUGIN_PATH . 'src/admin-views/meta-fields/_description.php'; ?>
        <?php include OTSLR_ADD_PLUGIN_PATH . 'src/admin-views/meta-fields/' . sanitize_file_name( $type ) . '.php'; ?>
